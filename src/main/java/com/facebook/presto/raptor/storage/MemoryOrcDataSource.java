...
{
    private static final Logger logger = Logger.get(MemoryOrcDataSource.class);
    ...
    public MemoryOrcDataSource(File path, DataSize maxMergeDistance, DataSize maxReadSize, DataSize streamBufferSize)
