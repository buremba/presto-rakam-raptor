        ...
        implements ConnectorPageSink
{
            ...
            implements PageWriter
    {
        ...
        public PartitionedPageWriter()
        {
            ...
            this.bucketFunction = bucketCount.isPresent() ? Optional.of(new IRaptorBucketFunction(bucketCount.getAsInt(), bucketTypes)) :
                    Optional.empty();
